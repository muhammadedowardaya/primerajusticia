        ...
        <div class="formBx active">
            ...
            <div class="form signinForm">
                <form action="/login" method="post">
                    @csrf
                    <h3>Sign In</h3>
                    <input type="email" placeholder="Email" id="email" autofocus
                ...
                <form action="/register" method="post">
                    ...
                    <div class="radio">
                        <div class="pilihan">
                            ...
                            <input type="radio" name="is_admin" class="@error('password') is-invalid @enderror"
                                id="admin" value="1" />
                        </div>
                        <div class="pilihan">
                            <label for="noAdmin">No Admin</label>
                            <input type="radio" checked name="is_admin" class="@error('password') is-invalid @enderror"
                                id="noAdmin" value="0" />
                        </div>
                        @error('password')
                            <div class="invalid-feedback">
